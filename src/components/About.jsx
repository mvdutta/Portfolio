        ...
        <div className="flex flex-col justify-center items-center w-full h-full">
          <div className="max-w-[1000px] w-full flex justify-center">
            <div className="sm:text-right pb-8">
              <p className="text-4xl sm:text-5xl font-semibold inline border-b-4 border-[#EA5955]">
                About
              </p>
            </div>
            <div></div>
          </div>
          <div className=" text-xl sm:text-2xl mb-8 flex justify-items-center">
            <ChangingText />
          </div>
          <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-3">
            <div className="sm:text-right text-3xl sm:text-4xl font-light">
